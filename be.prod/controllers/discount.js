        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, models_1.Discounts.find(query)
                            .sort({
                            createdAt: -1
                        })
                            .skip(Number(skip) || 0)
                ...
                case 1:
                    data = _b.sent();
                    return [4 /*yield*/, models_1.Discounts.countDocuments(query)];
                case 2:
                    total = _b.sent();
        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    return [4 /*yield*/, models_1.Discounts.create({
                            min: min,
                            max: max,
                            total: total,
                            left: total,
    ...
    put: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _id = req.query._id;
                    return [4 /*yield*/, models_1.Discounts.findByIdAndUpdate(_id, req.body)];
                case 1:
                    _a.sent();
                    res.send({ status: 1 });
                    return [2 /*return*/];
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _id = req.query._id;
                    return [4 /*yield*/, models_1.Discounts.findByIdAndDelete(_id)];
                case 1:
                    _a.sent();
                    res.send({ status: 1 });
                    return [2 /*return*/];
