...
var category = {
    ...
    post: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, models_1.Products.create(__assign(__assign({}, req.body), { slug: (0, slug_1.default)(req.body.name) + Date.now() }))];
                case 1:
                    _a.sent();
                    res.send({ status: 1 });
                    return [2 /*return*/];
    ...
    put: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _id = req.query._id;
                    return [4 /*yield*/, models_1.Products.findByIdAndUpdate(_id, req.body)];
                case 1:
                    _a.sent();
                    res.send({ status: 1 });
                    return [2 /*return*/];
    ...
    delete: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _id = req.query._id;
                    return [4 /*yield*/, models_1.Products.findByIdAndDelete(_id)];
                case 1:
                    _a.sent();
                    res.send({ status: 1 });
                    return [2 /*return*/];
