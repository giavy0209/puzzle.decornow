...
/* harmony import */ var constant__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(207);
...
/* harmony import */ var services_GHNService__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3802);
...
const Cart = ()=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
        (0,services_GHNService__WEBPACK_IMPORTED_MODULE_7__/* .fetchProvinces */ .QE)().then((res)=>setProvinces([
                ...res.data
            ])
        );
    }, []);
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
        if (ProvinceSelected) {
            (0,services_GHNService__WEBPACK_IMPORTED_MODULE_7__/* .fetchDistricts */ .hj)(ProvinceSelected).then((res)=>{
                setDistricts([
                    ...res.data
                ]);
            });
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
        if (DistrictsSelected) {
            (0,services_GHNService__WEBPACK_IMPORTED_MODULE_7__/* .fetchWards */ .zZ)(DistrictsSelected).then((res)=>{
                console.log(res);
                setWards([
                    ...res.data
                ]);
    ...
    const onChangeDistrict = (value)=>{
        ...
        (0,services_GHNService__WEBPACK_IMPORTED_MODULE_7__/* .fetchServices */ .Qz)(value).then((res)=>{
            console.log(res);
        });
        formRef.current.setFieldsValue({
            ...formRef.current.getFieldsValue(),
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
        if (ProvinceSelected && DistrictsSelected && WardSelected) {
            (0,services_GHNService__WEBPACK_IMPORTED_MODULE_7__/* .calculateFee */ .Z3)(DistrictsSelected, WardSelected).then((res)=>{
                console.log(res);
            });
        }
    }, [
    ...
    const handleFormDone = async (value)=>{
        ...
        for(let index = 0; index < cart.length; index++){
            ...
            if (item.file) {
                ...
                const thumbnail = `${constant__WEBPACK_IMPORTED_MODULE_9__/* .DOMAIN */ .y}${res.data.path}`;
